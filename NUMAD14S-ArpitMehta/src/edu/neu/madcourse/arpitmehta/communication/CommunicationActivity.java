...
public class CommunicationActivity extends Activity {
	...
	/**
	 * getGCMPreferences
	 * 		Returns the GCM Shared preferences
	 * 
	 ...
	 * 		getRegistrationId() returns an empty string to indicate that the 
...
//		startActivity(sendMessageActivityIntent);
	...
	/**
	 * showCommunicationAck
	 * 		Display the acknowledgements for the Communication Activity
	 * 
	 * @param View
	 */
	...
	/**
	 * quitActivity
	 * 		Quit activity and return to main menu
	 * 
	 * @param View
	 */
