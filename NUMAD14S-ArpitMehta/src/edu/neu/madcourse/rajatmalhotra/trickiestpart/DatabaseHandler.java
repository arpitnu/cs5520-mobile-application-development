...
public class DatabaseHandler extends SQLiteOpenHelper{
   ...
   /* public static DatabaseHandler getInstance(Context context) {
    ...
    public void onCreate(SQLiteDatabase db) {
    	...
    	String CREATE_WORKOUT_TABLE = "CREATE TABLE " + TABLE_WORKOUT + "("
    			...
    			+ WORKOUT_KEY_EXERCISE_NAME + " TEXT," 
    			+ WORKOUT_KEY_REPS + " INTEGER,"
                + WORKOUT_KEY_WEIGHT + " INTEGER" + ")";
 ...
 // Upgrading database
    ...
    WorkoutEntry getWorkoutEntry(int id) {
        ...
        Cursor cursor = db.query(TABLE_WORKOUT, new String[] { WORKOUT_KEY_ID,
        		WORKOUT_KEY_EXERCISE_NAME, WORKOUT_KEY_REPS, WORKOUT_KEY_WEIGHT}, KEY_ID + "=?",
        ...
        WorkoutEntry wEntry = new WorkoutEntry(Integer.parseInt(cursor.getString(0)),
   ...
   /* // Updating single exercise
    public int updateExercise(Exercise exercise) {
        ...
        // updating row
        int result = db.update(TABLE_EXERCISE, values, KEY_ID + " = ?",
