...
public class FtsIndexedExerciseDatabase {
	...
	public static synchronized FtsIndexedExerciseDatabase getInstance(Context context)
    {
        if (instance == null)
        {
            instance = new FtsIndexedExerciseDatabase(context.getApplicationContext());
        }
    ...
    {
        Cursor cursor = database.rawQuery("SELECT * FROM " + TABLE_EXERCISE, null);
    ...
    private static final class DatabaseHelper extends SQLiteOpenHelper {
        ...
        public void createTables(SQLiteDatabase db)
        {
            db.execSQL("CREATE VIRTUAL TABLE " + TABLE_EXERCISE
                    ...
                    + " TEXT, " + COLUMN_REPS + " REAL, " + COLUMN_WEIGHTS + " REAL);");
        }
    }
}
