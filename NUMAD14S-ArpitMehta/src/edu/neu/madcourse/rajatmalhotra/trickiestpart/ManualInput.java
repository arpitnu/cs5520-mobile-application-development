...
public class ManualInput extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		ArrayAdapter<String> adapter = new ArrayAdapter<String>(this,
				android.R.layout.select_dialog_item, exNames);

		// Getting the instance of AutoCompleteTextView
		AutoCompleteTextView actv = (AutoCompleteTextView) findViewById(R.id.exName);
	...
	public void addWorkoutEntry(View view) {
		...
		String exName = ((AutoCompleteTextView) findViewById(R.id.exName))
				.getText().toString();
		String reps = ((EditText) findViewById(R.id.reps)).getText().toString();
		String weight = ((EditText) findViewById(R.id.weight)).getText()
				.toString();

		if (exName.equals("") || reps.equals("") || weight.equals("")) {
			Toast.makeText(getApplicationContext(),
					"Please enter information in all the fields",
					Toast.LENGTH_SHORT).show();
		} else {
			WorkoutEntry we = new WorkoutEntry(exName, Integer.parseInt(reps),
